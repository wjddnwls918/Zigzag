...
import com.example.zigzag.databinding.ActivityZigzagListBinding
...
class ZigzagListActivity : AppCompatActivity(), ZigzagListNavigator {
    ...
    lateinit var binding: ActivityZigzagListBinding
    lateinit var viewModel: ZigzagListViewModel
    lateinit var adapter: ZigzagListAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_zigzag_list)
